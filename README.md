...
Merge images from different folders into one folder. Alternatively, you can have different folders for train, validation and test data but it's not necessary.
